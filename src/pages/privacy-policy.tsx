    ...
    <Stack>
      <Container>
        <Stack spacing={8} my={10}>
          ...
          <Text>
            This Privacy Policy describes how www.trycalmr.com (the "Site" or
          ...
          <Section>
            ...
            <Text>
              ...
              to make a complaint, please contact us by e-mail at info@calmr.com
          ...
          <Section>
            ...
            <Text>
              By choosing Calmr for your purchases, you allow us to send you
              marketing messages, notifications, SMS, and other promotional
              communications. If you wish to unsubscribe, please contact our
              support team via the provided email address. Your privacy matters
          ...
          <Section>
            ...
            <Text>
              ...
              on you or otherwise significantly affects you. We do not engage in
              fully automated decision-making that has a legal or otherwise
              significant effect using customer data. Our processor Shopify uses
              limited automated decision-making to prevent fraud that does not
          ...
          <Section>
            ...
            <Text>
              ...
              please contact us through the contact information above. Your
              Personal Information will be initially processed in Ireland and
              then will be transferred outside of Europe for storage and further
              processing, including to Canada and the United States.
            </Text>
          </Section>
          ...
          <Section>
            ...
            <Text>
              ...
              they are a frequent visitor. We use cookies to optimize your
          ...
          <Section>
            ...
            <Text>
              ...
              "Contact" above. If you are not satisfied with our response to
              your complaint, you have the right to lodge your complaint with
              the relevant data protection authority. You can contact your local
              data protection authority, the Federal Trade Commission (FTC) in
              the United States, or the Information Commissioner's Office in the
              UK.
            </Text>
          </Section>
