...
export function PurchaseTypeSelector({
  ...
  return (
    <Grid gridTemplateColumns={["1fr", "1fr 1fr"]} gap={2} mx="auto" maxW={"400px"} width={"100%"}>
      <Button
        size="md"
        ...
        boxShadow={purchaseType === "one-off" ? "0 0 0 3px #b83280" : "0 0 0 1px #febf03"}
      ...
      <Button
        ...
        boxShadow={purchaseType === "subscription" ? "0 0 0 3px #b83280" : "0 0 0 1px #febf03"}
