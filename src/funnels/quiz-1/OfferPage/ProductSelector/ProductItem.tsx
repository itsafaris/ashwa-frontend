...
import { ExtendedProduct } from "./ProductSelector";
...
export function ProductItem({
  ...
  return (
    <Stack
      spacing={0}
      cursor={"pointer"}
      boxShadow={isSelected ? "0 0 0 3px #b83280" : undefined}
    ...
    >
      ...
      >
        <Box position={"relative"}>
          <Box mx="auto" width={["unset", "unset", "80%"]}>
            {product.image}
          </Box>

          {product.giftProduct && (
            <Box
              width={["90px", "100px", "140px"]}
              position={"absolute"}
              bottom={["-5%", 0]}
              right={["-5%", 0]}
              zIndex={0}
            >
              ...
              <Image
                alt=""
                src={product.giftProduct.featuredImage?.url}
                width={100}
